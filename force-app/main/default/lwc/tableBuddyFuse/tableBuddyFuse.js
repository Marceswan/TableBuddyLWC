...
class w {
  ...
  setCollection(t, e) {
    if (((this._docs = t), e && !(e instanceof g)))
      throw new Error("Incorrect 'index' type");
    this._myIndex =
      e || p(this.options.keys, this._docs, { getFn: this.options.getFn });
  }
  add(t) {
      ...
      n.forEach(({ v: t, i: n, n: r }) => {
        ...
        o &&
          s.push({
            item: t,
            idx: n,
            matches: [{ score: c, value: t, norm: r, indices: h }]
          });
      }),
      s
    );
  ...
  _findMatches({ key: e, value: n, searcher: s }) {
    ...
    if (t(n))
      n.forEach(({ v: t, i: n, n: o }) => {
        ...
        c &&
          r.push({ score: h, key: e, value: t, idx: n, norm: o, indices: a });
      });
    else {
      const { v: t, n: i } = n,
